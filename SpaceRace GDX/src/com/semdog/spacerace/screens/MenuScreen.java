...
public class MenuScreen extends RaceScreen {
    ...
    public MenuScreen(RaceGame game) {
        ...
        button1 = new Button("Singleplayer", false, Gdx.graphics.getWidth() / 2, Gdx.graphics.getHeight() * 0.55f, 200,
                60, () -> game.changeScreen("playmenu"));
        button1.setColors(Colors.P_YELLOW, Colors.UI_BLUE);

        button2 = new Button("Multiplayer", false, Gdx.graphics.getWidth() / 2, Gdx.graphics.getHeight() * 0.55f - 61,
                200, 60, () -> game.changeScreen("multiplaymenu"));
        button2.setColors(Colors.UI_BLUE, Colors.P_YELLOW);

        button3 = new Button("Settings", false, Gdx.graphics.getWidth() / 2, Gdx.graphics.getHeight() * 0.55f - 122,
                200, 60, () -> game.changeScreen("settings"));
        button3.setColors(Colors.UI_YELLOW, Colors.UI_WHITE);

        button4 = new Button("Help", false, Gdx.graphics.getWidth() / 2, Gdx.graphics.getHeight() * 0.55f - 183, 200,
                60, () -> game.changeScreen("help"));
